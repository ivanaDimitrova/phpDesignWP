...
function septera_get_option_defaults() {
	...
	$sample_pages = septera_get_default_pages();
	...
	"septera_lpblockmainttitle"	=> '',
	"septera_lpblockmaindesc"	=> '',
	"septera_lpblockone"		=> $sample_pages[1],
	"septera_lpblockoneicon"	=> 'magic-wand',
	"septera_lpblocktwo"		=> $sample_pages[2],
	"septera_lpblocktwoicon"	=> 'directions',
	"septera_lpblockthree"		=> $sample_pages[3],
	"septera_lpblockthreeicon"	=> 'cup',
	"septera_lpblockfour"		=> 0,
	"septera_lpblockfouricon"	=> 'megaphone',
	"septera_lpblockscontent"	=> 1, // 0=disabled, 1=excerpt, 2=full
	"septera_lpblocksclick"		=> 0,
	...
	"septera_headeroverlayopacity" => 50,
	...
	"septera_articleanimation"	=> 2, // 0=none, 1=fade, 2=scroll, 3=grow
...
function septera_get_default_pages( $number = 4 ) {
