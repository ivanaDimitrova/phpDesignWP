...
function septera_lpslider() {
	$septeras = cryout_get_option( array( 'septera_lpslider', 'septera_lpsliderimage', 'septera_lpslidertitle', 'septera_lpslidertext', 'septera_lpslidershortcode', 'septera_lpsliderserious' ) );
...
function septera_lpboxes( $sid = 1 ) {
    ...
    if ( $custom_query->have_posts() ) : ?>
		<section class="lp-boxes lp-boxes-<?php echo absint( $sid ) ?> <?php  echo esc_attr( $animated_class ) ?> lp-boxes-rows-<?php echo absint( $septeras['septera_lpboxrow' . $sid] ); ?>">
